...
public class Equipacion extends Equipable{
    private Arma mano1;
    private Arma mano2;
    ...
    public Equipacion(Arma mano1, Arma mano2, Armadura armadura, Binoculares binoculares, boolean restringido, double multEnergiaCons, String nom, String des, double pes) {
        super(nom, des, pes);
        this.mano1 = mano1;
        this.mano2 = mano2;
        ...
        this.multEnergiaCons = multEnergiaCons;
    }
